...
public class DiffResult extends ProviderResult {
    ...
    public Map<String, Object> getSemanticDiff() {
        return semanticDiff;
    }

    public void setSemanticDiff(Map<String, Object> semanticDiff) {
        this.semanticDiff = semanticDiff;
    }

    public Map<String, Object> getHunks() {
        return hunks;
    }

    public void setHunks(Map<String, Object> hunks) {
        this.hunks = hunks;
    }
}