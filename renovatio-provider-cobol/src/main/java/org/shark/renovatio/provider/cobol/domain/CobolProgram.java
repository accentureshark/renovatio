...
public class CobolProgram {
    ...
    public void setEnvironmentDivision(CobolEnvironmentDivision environmentDivision) {
    ...
    public void setDataDivision(CobolDataDivision dataDivision) {
    ...
    public void setProcedureDivision(CobolProcedureDivision procedureDivision) {
...
class CobolEnvironmentDivision {
    ...
    public Map<String, String> getConfigurationSection() {
        return configurationSection;
    }

    public void setConfigurationSection(Map<String, String> configurationSection) {
        this.configurationSection = configurationSection;
    }

    public Map<String, String> getInputOutputSection() {
        return inputOutputSection;
    }

    public void setInputOutputSection(Map<String, String> inputOutputSection) {
...
class CobolDataDivision {
    ...
    public List<CobolDataItem> getWorkingStorageSection() {
        return workingStorageSection;
    }

    public void setWorkingStorageSection(List<CobolDataItem> workingStorageSection) {
        this.workingStorageSection = workingStorageSection;
    }

    public List<CobolDataItem> getFileSection() {
        return fileSection;
    }

    public void setFileSection(List<CobolDataItem> fileSection) {
        this.fileSection = fileSection;
    }

    public List<CobolDataItem> getLinkageSection() {
        return linkageSection;
    }

    public void setLinkageSection(List<CobolDataItem> linkageSection) {
...
class CobolProcedureDivision {
    ...
    public void setSections(List<CobolSection> sections) {
